...
/**
 * A basic button with standard, hovered, and pushed images. </br>
...
public class ButtonComponent extends GuiComponent {
	...
	public void render(SpriteBatch batch) {
		...
		switch (state) {
			case DEFAULT:
				batch.draw(image, bounds.x + shakeXOffset,
						subtextY + 1 + shakeYOffset, bounds.width,
						bounds.height);
				break;
			case HOVERED:
				batch.draw(imageHovered, bounds.x + shakeXOffset,
						subtextY + 1 + shakeYOffset, bounds.width,
						bounds.height);
				break;
			case PUSHED:
				batch.draw(imagePushed, bounds.x + shakeXOffset,
						subtextY + 1 + shakeYOffset, bounds.width,
						bounds.height);
				break;
		}
	...
	public void setImageHovered(Texture newImageHovered) {
		this.imageHovered = newImageHovered;
	}
	public void setImagePushed(Texture newImagePushed) {
		this.imagePushed = newImagePushed;
	}
	...
	public float getTextHeight() {
		return this.subtextLayout.height;
	}
	public float getTextWidth() {
		return this.subtextLayout.width;
	}
	public float getTextX() {
		return this.subtextX;
	}
	public float getTextY() {
		return this.subtextY;
	}
