...
public class TutorialButton extends ButtonComponent {
	...
	public void triggered() {
		...
		GameManager.getInstance().stateManager
				.enterState(GameManager.getInstance().stateId_tutorial);
	}
