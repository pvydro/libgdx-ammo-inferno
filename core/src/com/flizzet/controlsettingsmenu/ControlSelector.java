...
public class ControlSelector extends GuiComponent {
	...
	private GlyphLayout selectionLayout = new GlyphLayout(selectionFont,
			currentSelection);
	...
	public void update(float delta) {
		...
		/* Set text position */
		selectionX = MainCamera.getInstance().getCenterX()
				- (selectionLayout.width / 2);
		selectionY = MainCamera.getInstance().getHeight() - MARGIN
				+ selectionLayout.height + 5;
