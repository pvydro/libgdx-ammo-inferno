...
public class Weapons {
	 ...
	 * 
	 * @throws AlreadyLoaadedException
	 *             Weapons class is already loaded
	 */
	 ...
	 *             The weaponType (E) is not in the Weapons ArrayList.
	 */
	public <E> boolean isBought(Class<E> weaponType) {
		...
		throw new NullPointerException("The weaponType " + weaponType
				+ " is not in the Weapons ArrayList");
	}
				...
				if (!w.isBought()) {
					if (pay) {
						Player.getInstance().getScore()
								.removeFromCurrentCoins(w.getPrice());
						w.setBought(true);
					} else {
						w.setBought(true);
					}
	...
	public <E> Weapon getWeapon(Class<E> weaponType) {
		...
		throw new NullPointerException("Weapon type " + weaponType
				+ " is not in the Weapons ArrayList");
	}
