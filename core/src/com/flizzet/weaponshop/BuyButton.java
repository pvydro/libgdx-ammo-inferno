...
class BuyButton extends ButtonComponent {
	...
	public void setWeapon(Weapon newWeapon) {
		...
		/*
		 * Set the state of the button depending on whether or not the weapon is
		 * already bought/equipped
		 */
		...
		switch (newState) {
			case 0:
				...
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/weaponShop/buyButtonPushed.png", Texture.class));
				break;
			case 1:
				// Equip
				this.setImage(GameManager.getInstance().assetManager
						.get("gui/weaponShop/equipButton.png", Texture.class));
				this.setImageHovered(GameManager.getInstance().assetManager
						.get("gui/weaponShop/equipButton.png", Texture.class));
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/weaponShop/equipButtonPushed.png", Texture.class));
				break;
			case 2:
				// Equipped
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/weaponShop/equippedButton.png", Texture.class));
				this.setImageHovered(GameManager.getInstance().assetManager.get(
						"gui/weaponShop/equippedButton.png", Texture.class));
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/weaponShop/equippedButtonPushed.png",
						Texture.class));
				break;
		}
	}
