...
public class WeaponShopButton extends ButtonComponent {
	...
	public WeaponShopButton() {
		...
		this.setImage(GameManager.getInstance().assetManager.get(
				"gui/deathMenu/shopSelection/weaponButton.png", Texture.class));
		...
		this.setImagePushed(GameManager.getInstance().assetManager.get(
				"gui/deathMenu/shopSelection/weaponButtonPushed.png",
				Texture.class));
	...
	public void triggered() {
		...
		GameManager.getInstance().stateManager
				.enterState(GameManager.getInstance().stateId_weaponShop);
	}
