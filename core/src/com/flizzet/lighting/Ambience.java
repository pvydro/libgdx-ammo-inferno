...
public class Ambience implements Renderable {
	...
	public void render(SpriteBatch batch) {
		...
		if (enabled) {
			...
			/* Left */
			shapeRenderer.rect(-200, 0, 200,
					MainCamera.getInstance().getHeight());
			/* Right */
			shapeRenderer.rect(MainCamera.getInstance().getWidth(), 0, 200,
					MainCamera.getInstance().getHeight());
	...
	public void setAlpha(float newAlpha) {
		this.ambienceColor = new Color(this.ambienceColor.r,
				this.ambienceColor.g, this.ambienceColor.b, newAlpha);
	}
	...
	public boolean isAboveGui() {
		return this.aboveGui;
	}
	public Color getColor() {
		return this.ambienceColor;
	}
