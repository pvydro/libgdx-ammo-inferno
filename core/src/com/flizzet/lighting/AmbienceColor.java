...
enum AmbienceColor {
	...
	PURPLE(0.5f, 0.2f, 0.4f, 0.1f), ORANGE(0.7f, 0.4f, 0.2f, 0.1f), GREEN(0.7f,
			0.9f, 0.5f, 0.1f), PINK(0.9f, 0.4f, 0.6f, 0.1f), BLUE(0.5f, 0.8f,
					0.9f, 0.1f), BROWN(0.9f, 0.7f, 0.3f, 0.1f);
	...
	AmbienceColor(float redValue, float greenValue, float blueValue,
			float alphaValue) {
