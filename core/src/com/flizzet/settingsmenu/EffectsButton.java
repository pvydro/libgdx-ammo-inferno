...
public class EffectsButton extends ButtonComponent {
	...
	public EffectsButton() {
		...
		this.setImage(GameManager.getInstance().assetManager.get(
				"gui/settingsMenu/categories/effectsButton.png",
				Texture.class));
		...
		this.setImagePushed(GameManager.getInstance().assetManager.get(
				"gui/settingsMenu/categories/effectsButtonPushed.png",
				Texture.class));
	...
	public void triggered() {
		GameManager.getInstance().stateManager
				.enterState(GameManager.getInstance().stateId_effectsSettings);
	}
