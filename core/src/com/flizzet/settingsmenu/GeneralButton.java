...
public class GeneralButton extends ButtonComponent {
	...
	public GeneralButton() {
		...
		this.setImage(GameManager.getInstance().assetManager.get(
				"gui/settingsMenu/categories/generalButton.png",
				Texture.class));
		...
		this.setImagePushed(GameManager.getInstance().assetManager.get(
				"gui/settingsMenu/categories/generalButtonPushed.png",
				Texture.class));
	...
	public void triggered() {
		GameManager.getInstance().stateManager
				.enterState(GameManager.getInstance().stateId_generalSettings);
	}
