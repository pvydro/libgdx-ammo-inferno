...
public class DeathMenuBuilder {
	...
	public void buildMenu() {
		...
		replayButton.setX(MainCamera.getInstance().getCenterX()
				- replayButton.getWidth() - MARGIN);
		...
		replayButton.setY(MainCamera.getInstance().getCenterY());
		settingsButton.setX(MainCamera.getInstance().getCenterX()
				- settingsButton.getWidth() - MARGIN);
		settingsButton.setY(replayButton.getY() - settingsButton.getHeight()
				- STACK_MARGIN);
		quitButton.setX(MainCamera.getInstance().getCenterX() + MARGIN);
		quitButton.setY(
				shopButton.getY() - quitButton.getHeight() - STACK_MARGIN);
	...
	public float getStackMargin() {
		return this.STACK_MARGIN;
	}
