...
class UpgradeScrollCell extends ButtonComponent {
	...
	public UpgradeScrollCell(Upgrade upgrade, UpgradeScrollView view) {
		...
		this.setImage(bgImage = GameManager.getInstance().assetManager
				.get("gui/upgradeShop/scrollCell.png"));
		adjustBoundsToImage();
	}
	...
	public void render(SpriteBatch batch) {
		...
		batch.setColor(tmp.r - darkness, tmp.g - darkness, tmp.b - darkness,
				alpha);
