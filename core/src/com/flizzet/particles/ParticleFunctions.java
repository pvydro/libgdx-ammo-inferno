...
public class ParticleFunctions {
	...
	public void loadMuzzleFlashes() {
		Texture muzzleSheet0 = GameManager.getInstance().assetManager
				.get("particles/gameParticles/muzzleFlash0.png", Texture.class);
		Texture muzzleSheet1 = GameManager.getInstance().assetManager
				.get("particles/gameParticles/muzzleFlash1.png", Texture.class);
		Texture muzzleSheet2 = GameManager.getInstance().assetManager
				.get("particles/gameParticles/muzzleFlash2.png", Texture.class);
		Texture muzzleSheet3 = GameManager.getInstance().assetManager
				.get("particles/gameParticles/muzzleFlash3.png", Texture.class);
