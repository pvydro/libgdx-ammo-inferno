...
/**
 * Basic game state class. Meant to be extended by concrete classes and is
 * stored in GameStateManager.
 * 
...
public abstract class GameState {
	...
	/**
	 * Renders all objects in game state. Called after update once per frame.
	 * Takes batch for drawing
	 */
	...
	/**
	 * Called at the end of the game, dispose all garbage assets and stop all
	 * threads
	 */
