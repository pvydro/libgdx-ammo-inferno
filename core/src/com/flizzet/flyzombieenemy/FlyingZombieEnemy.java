...
public class FlyingZombieEnemy extends FlyingEnemy {
	...
	private FlyingZombieEnemyCollision collision = new FlyingZombieEnemyCollision(
			this);
	...
	public FlyingZombieEnemy() {
		...
		headImage = GameManager.getInstance().assetManager
				.get("enemies/flyingZombie/head.png", Texture.class);
		this.setHealthBar(new FlyingZombieHealthBar(this));
		this.setAi(new FlyingZombieEnemyAi(this));
		adjustBoundsToImage(headImage);

		/* Building animations */
		Texture wingSheetLeft = GameManager.getInstance().assetManager.get(
				"enemies/flyingZombie/zombieWingSheetLeft.png", Texture.class);
		Texture wingSheetRight = GameManager.getInstance().assetManager.get(
				"enemies/flyingZombie/zombieWingSheetRight.png", Texture.class);
