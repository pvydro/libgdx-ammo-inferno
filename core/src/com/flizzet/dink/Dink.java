...
/**
 * Flying robot that follows the player around and attacks. Purchasable upgrade.
 *
...
public class Dink extends Entity {
	...
	public Dink() {
		this.bodyImage = GameManager.getInstance().assetManager
				.get("upgrades/dink/body.png");
		this.adjustBoundsToImage(bodyImage);
		this.rotorSheet = GameManager.getInstance().assetManager
				.get("upgrades/dink/rotorSheet.png");
	...
	public void render(SpriteBatch batch) {
		...
		batch.draw(rotorCurrentFrame, bounds.x, bounds.y - 1); // Draw rotor
																// just below
																// body
	}

	public void setState(DinkState newState) {
		this.state = newState;
	}

	public DinkState getState() {
		return this.state;
	}
