		...
		switch (CurrentSettings.getInstance().controls) {
			case HORIZONTALARROWS:
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/arrows/moveRightBtn.png",
						Texture.class));
				...
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/arrows/moveRightBtnPushed.png",
						Texture.class));
				break;
			case CONSOLE:
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/moveRightBtn.png",
						Texture.class));
				this.setImageHovered(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/moveRightBtn.png",
						Texture.class));
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/moveRightBtnPushed.png",
						Texture.class));
				break;
			default:
				break;
