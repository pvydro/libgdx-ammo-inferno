		...
		switch (CurrentSettings.getInstance().controls) {
			case HORIZONTALARROWS:
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/arrows/moveLeftBtn.png",
						Texture.class));
				...
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/arrows/moveLeftBtnPushed.png",
						Texture.class));
				break;
			case CONSOLE:
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/moveLeftBtn.png",
						Texture.class));
				this.setImageHovered(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/moveLeftBtn.png",
						Texture.class));
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/moveLeftBtnPushed.png",
						Texture.class));
				break;
			default:
				break;
