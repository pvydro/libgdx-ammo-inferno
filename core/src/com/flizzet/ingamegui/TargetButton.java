...
public class TargetButton extends ButtonComponent {
	...
	public TargetButton() {
		...
		this.cooldownBarImage = GameManager.getInstance().assetManager
				.get("gui/inGame/movement/targetCooldownBar.png");
	}
	...
	public void update(float delta) {
		...
		/* Button cooldown */
		maxCooldown = Upgrades.getInstance().isEquipped(SwiftUpgrade.class)
				? 50
				: 300;
	...
	public void render(SpriteBatch batch) {
		...
		batch.draw(cooldownBarImage, this.getX() + 3 + shakeXOffset,
				this.getY() + shakeYOffset + this.getHeight()
						- cooldownBarImage.getHeight() - 5,
		...
		switch (CurrentSettings.getInstance().controls) {
			case HORIZONTALARROWS:
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/arrows/targetBtn.png",
						Texture.class));
				...
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/arrows/targetBtnPushed.png",
						Texture.class));
				break;
			case CONSOLE:
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/targetBtn.png",
						Texture.class));
				this.setImageHovered(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/targetBtn.png",
						Texture.class));
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/console/targetBtnPushed.png",
						Texture.class));
				break;
			case TILT:
			case JOYSTICK:
				this.setImage(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/joystick/targetBtn.png",
						Texture.class));
				this.setImageHovered(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/joystick/targetBtn.png",
						Texture.class));
				this.setImagePushed(GameManager.getInstance().assetManager.get(
						"gui/inGame/movement/joystick/targetBtnPushed.png",
						Texture.class));
				break;
			default:
				break;
