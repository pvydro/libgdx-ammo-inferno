...
public class ZombieEnemy extends Enemy {
	...
	public ZombieEnemy(Platform platform) {
		...
		if (random.nextInt(5) == 3) {
			Sounds.play(Sounds.getInstance().zombieGroanSound, 1.5f,
	...
	public ZombieEnemyAiEasy getAi() {
		return (ZombieEnemyAiEasy) this.ai;
	}
	public ZombieEnemyAnimator getAnimator() {
		return this.animator;
	}
	public ZombieEnemyHead getHead() {
		return this.head;
	}
