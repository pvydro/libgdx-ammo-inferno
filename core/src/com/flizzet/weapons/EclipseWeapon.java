...
public class EclipseWeapon extends Weapon {
	...
	public EclipseWeapon() {
		...
		this.setImage(GameManager.getInstance().assetManager
				.get("weapons/eclipse.png", Texture.class));
		this.setImageNoHand(GameManager.getInstance().assetManager
				.get("weapons/noHand/eclipse.png", Texture.class));
		this.setImageGold(GameManager.getInstance().assetManager
				.get("weapons/gold/eclipse.png", Texture.class));
		this.setImageGoldNoHand(GameManager.getInstance().assetManager
				.get("weapons/noHand/gold/eclipse.png", Texture.class));
		this.topFireRate = 11;
