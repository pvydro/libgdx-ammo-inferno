...
public class Platform extends Entity {
	...
	public void addRandomEnemy() {
		if (MainEnemySpawner.getInstance().isZombiesEnabled()
				&& zombieSpawner.isSpawning()) {
			zombie = new ZombieEnemy(this);
		} else if (MainEnemySpawner.getInstance().isTrapsEnabled()
				&& addRandomGunTrapEnemy()) {
			gunTrap = new GunTrapEnemy(this);
		} else if (MainEnemySpawner.getInstance().isSawsEnabled()
				&& addRandomSawEnemy()) {
			saw = new SawEnemy(this);
		} else if (MainEnemySpawner.getInstance().isSpikesEnabled()
				&& addRandomSpikeEnemy()) {
	...
	public ZombieEnemy getZombieEnemy() {
		return this.zombie;
	}
	public GunTrapEnemy getGunTrapEnemy() {
		return this.gunTrap;
	}
	public SawEnemy getSawEnemy() {
		return this.saw;
	}
	public SpikeEnemy getSpikeEnemy() {
		return this.spike;
	}
	public int getSide() {
		return this.side;
