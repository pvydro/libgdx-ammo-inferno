...
public class CreditsButton extends ButtonComponent {
	...
	this.setImage(GameManager.getInstance().assetManager.get("gui/settingsMenu/categories/general/creditsButton.png", Texture.class));
	this.setImageHovered(GameManager.getInstance().assetManager.get("gui/settingsMenu/categories/general/creditsButton.png", Texture.class));
	this.setImagePushed(GameManager.getInstance().assetManager.get("gui/settingsMenu/categories/general/creditsButtonPushed.png", Texture.class));
	...
	GameManager.getInstance().stateManager.enterState(GameManager.getInstance().stateId_credits);
    }
