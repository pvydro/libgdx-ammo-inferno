...
public class FlyingBatEnemy extends FlyingEnemy {
    ...
    private FlyingBatEnemyCollision collision = new FlyingBatEnemyCollision(this);
	...
	headImage = GameManager.getInstance().assetManager.get("enemies/flyingBat/batHead.png", Texture.class);
	this.setHealthBar(new FlyingBatHealthBar(this));
	this.setAi(new FlyingBatEnemyAi(this));
	adjustBoundsToImage(headImage);
	
	/* Building animations */
	Texture wingSheetLeft = GameManager.getInstance().assetManager.get("enemies/flyingBat/batWingSheetLeft.png", Texture.class);
	Texture wingSheetRight = GameManager.getInstance().assetManager.get("enemies/flyingBat/batWingSheetRight.png", Texture.class);
