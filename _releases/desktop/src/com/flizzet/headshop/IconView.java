...
public class IconView extends GuiComponent {
	...
	int currentColumn = 0;
	int currentRow = 0;
	float baseX = MainCamera.getInstance().getCenterX() - ((headIcons.get(0).getWidth() + 2) * 2);
	float baseY = MainCamera.getInstance().getCenterY() + ((headIcons.get(0).getHeight() + 2) * 2);
    ...
    public ArrayList<HeadIcon> getHeadIcon() 	{ return this.headIcons; }
