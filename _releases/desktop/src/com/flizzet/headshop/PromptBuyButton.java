...
class PromptBuyButton extends ButtonComponent {
	...
	case 0:
		...
		GameNotification notification = new GameNotification("bought " + head.getName());
	...
	case 1:									// Already bought
	    GameNotification notification = new GameNotification("already purchased");
	    GameManager.getInstance().guiContainer.addToGui(notification);
	    break;
	}
    }
	...
	case 0:
	    ...
	    break;
	case 1:
	    this.setImage(GameManager.getInstance().assetManager.get("gui/prompt/boughtButton.png", Texture.class));
	    this.setImageHovered(GameManager.getInstance().assetManager.get("gui/prompt/boughtButton.png", Texture.class));
	    this.setImagePushed(GameManager.getInstance().assetManager.get("gui/prompt/boughtButtonPushed.png", Texture.class));
	    break;
	}
    }
