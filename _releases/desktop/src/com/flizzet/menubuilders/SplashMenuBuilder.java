...
public class SplashMenuBuilder extends MenuBuilder {
	...
	/* Setting up background (Automatically sets position inside of SplashBackgroundComponent class
	 * This is because it's a background and it's not meant to be in the top corner or something */
