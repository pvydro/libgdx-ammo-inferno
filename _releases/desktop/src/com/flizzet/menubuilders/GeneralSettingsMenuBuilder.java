...
public class GeneralSettingsMenuBuilder extends MenuBuilder {
	...
	for (CheckboxComponent c : checkboxes) {
	    ...
	    c.setY(separator.getY() - 3 - (c.getHeight() + 5) * totalCheckboxes);
	...
	creditsButton.setX(MainCamera.getInstance().getCenterX() - (creditsButton.getWidth() / 2));
	creditsButton.setY(finalSeparator.getY() - creditsButton.getHeight() - 10);
    }
