...
public class PauseMenuBuilder extends MenuBuilder {
	...
	int totalButtons = 0;
	for (ButtonComponent b : buttons) {
	    b.setX(MainCamera.getInstance().getCenterX() - (resumeButton.getWidth() / 2));
	    b.setY(totalMargin - STACK_MARGIN - ((b.getHeight() + STACK_MARGIN) * totalButtons));
	    totalButtons++;
    ...
    public ButtonComponent getResumeButton()	{ return this.resumeButton; }
