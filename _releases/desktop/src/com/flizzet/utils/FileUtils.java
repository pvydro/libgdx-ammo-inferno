...
public class FileUtils {
	...
	// DEV - Creates a file with the directory of every asset for optimized retrieval, removes need of .list();
	
	
	String newText = "";
	FileHandle refsFile = Gdx.files.local("dirs.txt");
	for (FileHandle f : resultList) {
	    newText = newText + f.file().getPath() + "\n";
	}
