...
public class SeparatorFillerComponent extends GuiComponent {
    ...
    public SeparatorFillerComponent(SeparatorComponent separator1, SeparatorComponent separator2) {
	super(0, 0);
	
	this.separator1 = separator1;
	this.separator2 = separator2;
	this.color = new Color(Color.BLACK.r, Color.BLACK.g, Color.BLACK.b, 0.4f);
    }
