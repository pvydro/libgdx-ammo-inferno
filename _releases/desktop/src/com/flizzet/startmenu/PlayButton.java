...
public class PlayButton extends ButtonComponent {
	...
	this.setImage(GameManager.getInstance().assetManager.get("gui/startMenu/playButton.png", Texture.class));
	this.setImageHovered(GameManager.getInstance().assetManager.get("gui/startMenu/playButton.png", Texture.class));
	this.setImagePushed(GameManager.getInstance().assetManager.get("gui/startMenu/playButtonPushed.png", Texture.class));
	...
	GameManager.getInstance().stateManager.enterState(GameManager.getInstance().stateId_play);
    }
