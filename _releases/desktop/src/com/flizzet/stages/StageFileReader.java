...
public class StageFileReader {
	...
	stageDirs = new String[] {
		"stages/stage1.stg", "stages/stage2.stg", "stages/stage3.stg",
		"stages/stage4.stg", "stages/stage5.stg", "stages/stage6.stg",
		"stages/stage7.stg", "stages/stage8.stg", "stages/stage9.stg",
		"stages/stage10.stg"
	};
    }
	...
	for (String s : wordsArray) {
		...
		break;
	    case 5:					// Flying zombie enemy enabled		BOOOLEAN
