...
class GroundParticle extends Particle {
    ...
    private int removeCooldown = CurrentSettings.getInstance().groundParticleLifetime;
	...
	/* Fall */
	fall(delta);
	this.setY(this.getY() + yVel + PlatformGenerator.getInstance().getSpeed());
	...
	if (draw) {
	    ...
	    shapeRenderer.setColor(lightOrDark ? Color.DARK_GRAY : Color.LIGHT_GRAY);
