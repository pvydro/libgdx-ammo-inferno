...
public abstract class Particle extends Entity {
    ...
    protected boolean hit = false;	// For particles that go constantly upwards requiring collision
    ...
    public void bounce(Platform platform, boolean vertical, boolean horizontal) {
	if (vertical) {
	    if (yVel < -.5) {
		yVel = (-yVel * 0.5f);
	    } else {
    ...
    /** Decreases the vertical velocity of the particle if the particle doesn't explicitely have a drop */
