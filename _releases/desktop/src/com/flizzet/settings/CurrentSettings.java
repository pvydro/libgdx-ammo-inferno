...
public class CurrentSettings {
    ...
    public boolean loseHealth = true;			// Only to be used for testing when I'm not tryna die
    public boolean brokeBoi = false;
    ...
    public int groundParticleTotal = 10;		// Less is more, total time between these particles being created
