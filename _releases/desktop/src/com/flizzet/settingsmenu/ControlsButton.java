...
public class ControlsButton extends ButtonComponent {
	...
	this.setImage(GameManager.getInstance().assetManager.get("gui/settingsMenu/categories/controlsButton.png", Texture.class));
	this.setImageHovered(GameManager.getInstance().assetManager.get("gui/settingsMenu/categories/controlsButton.png", Texture.class));
	this.setImagePushed(GameManager.getInstance().assetManager.get("gui/settingsMenu/categories/controlsButtonPushed.png", Texture.class));
	...
	GameManager.getInstance().stateManager.enterState(GameManager.getInstance().stateId_controlsSettings);
    }
