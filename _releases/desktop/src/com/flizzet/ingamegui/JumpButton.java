...
class JumpButton extends ButtonComponent {
	...
	case HORIZONTALARROWS:
	    this.setImage(GameManager.getInstance().assetManager.get("gui/inGame/movement/arrows/jumpBtn.png", Texture.class));
	    this.setImageHovered(GameManager.getInstance().assetManager.get("gui/inGame/movement/arrows/jumpBtn.png", Texture.class));
	    this.setImagePushed(GameManager.getInstance().assetManager.get("gui/inGame/movement/arrows/jumpBtnPushed.png", Texture.class));
	    break;
	case CONSOLE:
	    this.setImage(GameManager.getInstance().assetManager.get("gui/inGame/movement/console/jumpBtn.png", Texture.class));
	    this.setImageHovered(GameManager.getInstance().assetManager.get("gui/inGame/movement/console/jumpBtn.png", Texture.class));
	    this.setImagePushed(GameManager.getInstance().assetManager.get("gui/inGame/movement/console/jumpBtnPushed.png", Texture.class));
	    break;
	default:
	    break;
	}
