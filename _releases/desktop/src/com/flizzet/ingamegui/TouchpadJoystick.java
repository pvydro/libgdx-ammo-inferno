...
public class TouchpadJoystick extends GuiComponent {
	...
	touchpadSkin = new Skin();
        touchpadSkin.add("touchBackground", GameManager.getInstance().assetManager.get("gui/inGame/movement/console/touchpad/touchpadBackground.png"));
        touchpadSkin.add("touchKnob", GameManager.getInstance().assetManager.get("gui/inGame/movement/console/touchpad/touchpadKnob.png"));
