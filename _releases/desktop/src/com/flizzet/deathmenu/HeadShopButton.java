...
public class HeadShopButton extends ButtonComponent {
	...
	this.setImage(GameManager.getInstance().assetManager.get("gui/deathMenu/shopSelection/headButton.png", Texture.class));
	this.setImageHovered(GameManager.getInstance().assetManager.get("gui/deathMenu/shopSelection/headButton.png", Texture.class));
	this.setImagePushed(GameManager.getInstance().assetManager.get("gui/deathMenu/shopSelection/headButtonPushed.png", Texture.class));
	...
	GameManager.getInstance().stateManager.enterState(GameManager.getInstance().stateId_headShop);
    }
