...
public class StateManager {
	...
	for(int i = 0; i < gameStates.size(); i++) {	// Go through states and match stateId
	...
	throw new NullPointerException("State doesn't exist!");		// Throw an exception if the state doesn't exist
    }
