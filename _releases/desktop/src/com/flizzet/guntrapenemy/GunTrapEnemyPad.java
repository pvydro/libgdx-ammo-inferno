...
public class GunTrapEnemyPad extends Entity {
	...
	this.image = GameManager.getInstance().assetManager.get("enemies/gunTrap/pressurePad.png", Texture.class);
	...
	if (platform.getSide() == 0) {		// Left
	    ...
	    this.setX(platform.getX() + random.nextInt((int) (platform.getWidth() - this.getWidth())));
	}
	else {				// Right
    ...
    public GunTrapEnemy getTrap()	{ return this.trap; }
