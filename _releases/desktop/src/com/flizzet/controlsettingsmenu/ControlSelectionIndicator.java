...
class ControlSelectionIndicator extends GuiComponent {
	...
	this.indicatorImage = GameManager.getInstance().assetManager.get("gui/settingsMenu/controls/selectionIndicator.png", Texture.class);
	...
	batch.draw(indicatorImage, bounds.x, bounds.y, bounds.width, bounds.height);
    }
    ...
    public void setSelection(ControlOption newSelection)	{ this.currentSelection = newSelection; }
