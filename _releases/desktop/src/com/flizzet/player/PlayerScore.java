...
public class PlayerScore {
	...
	if (this.platforms > highScore) {
	    highScore = platforms;
	    if (!highScoreShown) {
		GameNotification highScoreNoti = new GameNotification("new high score");
    ...
    public int getTotalCoins()			{ return this.totalCoins; }
    /** Returns the players total bills */
    public int getTotalBills() 			{ return this.totalBills; }
    /** Returns the players current platforms */
    public int getPlatforms()			{ return this.platforms; }
    ...
    public boolean isHighScoreShown()		{ return this.highScoreShown; }
    
    /**
     * Saving
     */
    /** Sets the total coins to a defined amount */
    public void setCoins(int newCoins)		{ this.totalCoins = newCoins; }
    /** Sets the total bills to a defined amount */
    public void setBills(int newBills)		{ this.totalBills = newBills; }
    /** Sets the total platforms to a defined amount */
    public void setPlatforms(int newPlatforms)	{ this.totalPlatforms = newPlatforms; }
    /** Sets the players high score to a defined amount */
    public void setHighScore(int newHighScore)	{ this.highScore = newHighScore; }
